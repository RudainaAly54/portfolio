...
function updateActiveButton() {
	...
	buttons.forEach(btn => {
		...
		btn.classList.remove('bg-gradient-to-r', 'from-[#4277ff]', 'via-[#735aff]', 'to-[#9227fb]');
		
		if (isActive) {
			// Add gradient classes for active button
			btn.classList.add('bg-gradient-to-r', 'from-[#4277ff]', 'via-[#735aff]', 'to-[#9227fb]');
		}
